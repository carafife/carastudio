		...
		switch(fieldtag)
		{
			...
			case 0x000c: /* D1 White Balance */
				if (g_str_equal(meta->model_ascii, "NIKON D1X")
				    ...
				    || g_str_equal(meta->model_ascii, "NIKON D800")
				    || g_str_equal(meta->model_ascii, "NIKON D800E")
				    || g_str_equal(meta->model_ascii, "NIKON D3100")
				    || g_str_equal(meta->model_ascii, "NIKON D3200")
				    || g_str_equal(meta->model_ascii, "NIKON D5000")
				    || g_str_equal(meta->model_ascii, "NIKON D5100")
				    || g_str_equal(meta->model_ascii, "NIKON D5200")
				    || g_str_equal(meta->model_ascii, "NIKON 1 J1")
				    || g_str_equal(meta->model_ascii, "NIKON 1 J2")
